...
{\centering \includegraphics[width=0.9\linewidth]{images/ragondin2} 

}

\caption{Photograph of coypus (Myocastor coypus) taken in the Lez watershed near Montpellier, France. Credits: Yann Raulet.}(\#fig:ragondinos)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{01-principles_files/figure-latex/bernoulli-binomiale-1} 

}

\caption{Discrete probability distributions, Bernoulli and binomial, illustrated with 100 simulations (random draws generated by computer). On the top row, we show the observed frequency from a Bernoulli draw for different values of survival probability \(\theta\). On the bottom row, we show histograms for a binomial draw with 50 trials and different values of survival probability \(\theta\).}(\#fig:bernoulli-binomiale)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{01-principles_files/figure-latex/survie-vraisemblance-mle-1} 

}

\caption{Likelihood function for the winter survival probability of the coypu, computed from $y=19$ survivors out of $n=57$ individuals monitored by GPS. The maximum likelihood estimate is indicated by the red dashed line.}(\#fig:survie-vraisemblance-mle)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{01-principles_files/figure-latex/beta-exemples-1} 

}

\caption{Examples of beta distributions for different values of parameters $a$ and $b$. In each panel, the shaded areas illustrate the probability of observing a value within a given interval.}(\#fig:beta-exemples)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{01-principles_files/figure-latex/posterior-survie-1} 

}

\caption{Uniform prior (red) and posterior distribution (black) of the coypu winter survival probability. The blue dashed line corresponds to the maximum likelihood estimate.}(\#fig:posterior-survie)
\end{figure}
